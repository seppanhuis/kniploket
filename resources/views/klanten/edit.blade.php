        ...
        <form method="POST" action="{{ route('klanten.update', $klant->Id ?? $klant->id) }}" class="max-w-3xl rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
            ...
            <div class="grid gap-5 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" id="telefoonnummer" name="telefoonnummer" value="{{ old('telefoonnummer', $klant->Telefoonnummer ?? $klant->telefoonnummer ?? '') }}" required class="block w-full rounded-xl border-zinc-300 bg-white px-4 py-2.5 text-zinc-900 shadow-sm focus:border-zinc-900 focus:ring-zinc-900 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100">
                </div>
